...
function MatriculaPage() {
    ...
    return (
        <div className="min-h-screens ">
                                        ...
                                        <td className="p-2 border-gray-300">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <button
                                                    ...
                                                    className="p-2 rounded-lg hover:bg-red-100 transition hover:cursor-pointer"
                                                    title="Eliminar"
                                                >
                                                ...
                                                <button
                                                    onClick={() => {
                                                        setEditData(item);
                                                        setShowModal(true);
                                                        console.log("Datos que paso al modal:", item);
                                                    }}
                                                    className="p-2 rounded-lg hover:bg-blue-100 transition hover:cursor-pointer"
                                                    title="Editar"
                                                >
            ...
            {/* MODAL - CORREGIDO: Ahora pasa initialData correctamente */}
            {showModal && (
                <div className="fixed inset-0 flex items-center justify-center bg-black/50 z-50">
                    <div className="bg-white rounded-2xl shadow-lg w-full max-w-5xl aspect-video">
                        <div className="flex justify-between p-4 ">
                            ...
                            <button 
                                onClick={closeModal} 
                                className="text-red-700 text-2xl hover:bg-red-100 rounded-full flex items-center justify-center w-12 h-12 hover:cursor-pointer"
                            >
                                <FiX />
                            </button>
                        </div>
                        ...
                        <div className="p-6">
                            <MatriculaForm
                                key={editData?.id || 'new'} // Fuerza re-render cuando cambia editData
                                initialData={editData} // ✅ PASAMOS LOS DATOS DE EDICIÓN
                                onSave={() => {
                                    fetchMatriculas();
                                    closeModal(); // Usar closeModal en lugar de setShowModal directamente
                                }}
                            />
                        </div>
                    </div>
